            ...
            <div class="col-md-12 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('master/packaging/Mst_Packaging/simpanData') ?>">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="txtpackagingid" id="txtpackagingid" class="form-control" placeholder="Input Packaging ID">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="txtpackagingname" id="txtpackagingname" class="form-control" placeholder="Input Packaging Name">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-md-2">
