            ...
            <div class="col-md-12 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('master/sub_product/Mst_Sub_Product/simpanData') ?>">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="txtsubproductid" id="txtsubproductid" class="form-control" placeholder="Input Sub Product ID">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="txtsubproductname" id="txtsubproductname" class="form-control" placeholder="Input Sub Product Name">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-md-2">
