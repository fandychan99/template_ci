                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="<?php echo base_url(); ?>app-assets/images/pages/login3.png" alt="branding logo">
                                </div>
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h2 class="mb-0 mt-1">Login</h2>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form action="<?php echo base_url(); ?>/Login/action_login" method="post" role="form">
                                                    <?php echo $message; ?>
                                                    ...
                                                    <button type="submit" class="btn btn-primary float-right btn-inline"><i class="fa fa-sign-in mr-1"></i>Login</button>
                                                </form>
                                            </div>
                                        </div>
