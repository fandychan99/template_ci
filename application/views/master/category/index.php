            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"><i class="fa fa-list-alt mr-2"></i>MASTER CATEGORY</h4>
                        <a href="<?php echo base_url('master/category/Mst_Category/tambahData'); ?>" style="float: right;">
                                    ...
                                    foreach($_getData as $get){?>
                                        <tr>
                                            <td class="text-center">
                                                <a href="<?php echo base_url('master/category/Mst_Category/editData/'.$get->CategoryID); ?>" class="btn btn-icon btn-sm btn-info waves-effect waves-light"><i class="fa fa-pencil"></i></a>
                                                <a href="#" class="btn btn-icon btn-sm btn-danger waves-effect waves-light"><i class="fa fa-trash"></i></a>
                                            </td>
                                            <td><?php echo $get->CategoryID;?></td>
