            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"><i class="feather icon-tag"></i> Rencana Terima Kelapa</h4>
                    </div>
...
<script type="text/javascript">
    ...
    function callAjax(){
        ...
        $url = "<?php echo base_url('rekap_terima_bahan_baku/transaction/Trn_Rencana_Terima_Kelapa/getForm')?>"+"?bulan=" + bulan + "&tahun=" + tahun;
        console.log($url);
