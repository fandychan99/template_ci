...
<script type="text/javascript">
    ...
    function search(){
        ...
        if (jenis_mtr == ''){
            ...
            $.ajax({
                type: "POST",
                url : "<?php echo  base_url('rekap_produksi/monitoring/nanas/Mtr_Rekap_Produksi_Nanas/mtr_bulan_tahun/')?>",
                data: {
                    bulan : bulan,
                    tahun : tahun,
                },
            ...
            $.ajax({
                type: "POST",
                url : "<?php echo  base_url('rekap_produksi/monitoring/nanas/Mtr_Rekap_Produksi_Nanas/mtr_tahun/')?>",
                data: {
                    tahun : tahun,
                },
                success: function(msg){
