                                                                ...
                                                                foreach($results as $r3){
                                                                    ...
                                                                    echo "
                                                                        <td>
                                                                            ...
                                                                            <input type='text' name='price[]' id='price-".$id3."0' class='form-control'  value='0'>
                                                                        </td>";
                                                                    foreach($_getLabel as $l){
                                                                        $a = "price-$id3$l->id"; $b = "price-$id3"."0"; $c = "price-$id3$l->id-A"; $fc = "hitung('".$a."', '".$b."', '".$c."')"; ?>
                                                                        <td><input type="text" class="form-control" name="price[]" id="price-<?=$id3;?><?=$l->id;?>" value="0" onkeyup="<?=$fc; ?>">
                                                                        ...
                                                                        echo "<td><input type='text' class='form-control' name='price[]' id='price-$id3$l->id-A' value='0' readonly>";
