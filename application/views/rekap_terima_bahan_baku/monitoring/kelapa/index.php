...
<script type="text/javascript">
    ...
    function search(){
        ...
        if (jenis_mtr == ''){
            ...
            $.ajax({
                type: "POST",
                url : "<?php echo  base_url('rekap_terima_bahan_baku/monitoring/Mnt_Terima_Kelapa/mtr_bulan_tahun/')?>",
                data: {
                    bulan : bulan,
                    tahun : tahun,
                },
            ...
            $.ajax({
                type: "POST",
                url : "<?php echo  base_url('rekap_terima_bahan_baku/monitoring/Mnt_Terima_Kelapa/mtr_tahun/')?>",
                data: {
                    tahun : tahun,
                },
                success: function(msg){
