            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"><i class="feather icon-box"></i> MASTER SUB PRODUCT</h4>                            
                            <a href="<?php echo base_url('master/sub_product/Mst_Sub_Product/tambahData'); ?>" style="float: right;">
                                ...
                                <table class="table table-striped table-bordered complex-headers">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Sub Product ID</th>
                                        ...
                                        <?php 
                                            ...
                                            foreach($_getData as $get){?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?php echo $get->SubProductID;?></td>
                                                    <td class="text-center"><?php echo $get->SubProductName;?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        echo $get->UpdateBy; 
                                                        echo '</br>';
                                                        if($get->UpdateDate != NULL){echo date('d-M-Y H:i:s',strtotime($get->Update));}else{echo '';}
                                                        ?>
                                                    </td>
                                                    <td class="text-center">
                                                        <a href="<?php echo base_url('master/sub_product/Mst_Sub_Product/editData/'.$get->SubProductID); ?>" class="btn btn-icon btn-sm btn-info waves-effect waves-light"><i class="fa fa-edit"></i></a>
